...
import { ZERO_ADDRESS } from './v2-helpers/constants';
import { BigNumberish, bn } from './v2-helpers/numbers';

import { BalancerErrors } from '@balancer-labs/balancer-js';
import { NAry } from './v2-helpers/types/types';
import { expectEqualWithError, expectLessThanOrEqualWithError } from './v2-helpers/test/relativeError';
...
chai.use(function (chai, utils) {
  ...
  Assertion.overwriteMethod('revertedWith', function (_super) {
    return async function (this: any) {
      ...
      const assertion = _super.apply(this, ...this);
