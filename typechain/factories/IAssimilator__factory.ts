...
import type { IAssimilator, IAssimilatorInterface } from "../IAssimilator";
...
export class IAssimilator__factory {
  ...
  static createInterface(): IAssimilatorInterface {
    return new utils.Interface(_abi) as IAssimilatorInterface;
  }
  static connect(
    address: string,
