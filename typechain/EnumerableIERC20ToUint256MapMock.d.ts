...
interface EnumerableIERC20ToUint256MapMockInterface
  ...
  functions: {
    ...
    "unchecked_setAt(uint256,uint256)": FunctionFragment;
...
export class EnumerableIERC20ToUint256MapMock extends BaseContract {
