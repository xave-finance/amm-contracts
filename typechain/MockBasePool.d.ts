...
interface MockBasePoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setMiscData(bytes32)": FunctionFragment;
...
export class MockBasePool extends BaseContract {
  ...
  functions: {
    ...
    getMiscData(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    setMiscData(data: BytesLike, overrides?: CallOverrides): Promise<void>;
