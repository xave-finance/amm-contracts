...
interface MockFactoryCreatedContractInterface extends ethers.utils.Interface {
  functions: {
...
export class MockFactoryCreatedContract extends BaseContract {
  ...
  interface: MockFactoryCreatedContractInterface;

  functions: {
    getId(overrides?: CallOverrides): Promise<[string]>;
  };
