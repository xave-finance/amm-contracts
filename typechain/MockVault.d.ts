...
interface MockVaultInterface extends ethers.utils.Interface {
  functions: {
    ...
    "callGeneralPoolSwap(address,(uint8,address,address,uint256,bytes32,uint256,address,address,bytes),uint256[],uint256,uint256)": FunctionFragment;
    ...
    "updateBalances(bytes32,uint256[])": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "callGeneralPoolSwap",
    values: [
      string,
      {
        kind: BigNumberish;
