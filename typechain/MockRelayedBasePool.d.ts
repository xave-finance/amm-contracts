...
interface MockRelayedBasePoolInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "Exit(bytes32,address,address,bytes,uint256[])": EventFragment;
    "Join(bytes32,address,address,bytes,uint256[])": EventFragment;
...
export class MockRelayedBasePool extends BaseContract {
  ...
  interface: MockRelayedBasePoolInterface;
  ...
  filters: {
    ...
    "Exit(bytes32,address,address,bytes,uint256[])"(
      poolId?: null,
      sender?: null,
      recipient?: null,
      userData?: null,
    ...
    "Join(bytes32,address,address,bytes,uint256[])"(
      poolId?: null,
      sender?: null,
      recipient?: null,
      userData?: null,
