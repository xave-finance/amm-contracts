...
interface IRelayedBasePoolInterface extends ethers.utils.Interface {
  functions: {
...
export class IRelayedBasePool extends BaseContract {
  ...
  interface: IRelayedBasePoolInterface;
