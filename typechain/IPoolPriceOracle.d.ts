...
interface IPoolPriceOracleInterface extends ethers.utils.Interface {
  functions: {
...
export class IPoolPriceOracle extends BaseContract {
  ...
  interface: IPoolPriceOracleInterface;
