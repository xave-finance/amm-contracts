...
interface MockPoolSplitCodeFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class MockPoolSplitCodeFactory extends BaseContract {
  ...
  interface: MockPoolSplitCodeFactoryInterface;
