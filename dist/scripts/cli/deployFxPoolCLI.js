...
var haloContractAddresses = require('@halodao/xave-contract-addresses')
var runNpmCommand = function (command) {
...
inquirer
  ...
  .then(function (answers) {
    ...
    return runNpmCommand(
      'npx hardhat deploy-fx-pool --to '
        .concat(network, ' --basetoken ')
        .concat(baseToken, ' --fresh ')
        .concat(fresh, ' --network ')
        .concat(network)
    )
  })
